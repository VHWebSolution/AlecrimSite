  ...
  return (
    <section class="text-gray-600 body-font relative" id='contato'>
        <div class="container px-5 pt-24 mx-auto">
            ...
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Você pode enviar um email preenchendo os campos abaixo.</p>
            </div>
            ...
            <div class="flex flex-wrap -m-2">
                ...
                <div class="p-2 w-full">
                <button class="flex mx-auto text-white bg-[#18975F] border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">Enviar</button>
                </div>
                <div class="p-2 w-full pt-8 border-t border-gray-200 text-center">
                <a class="text-[#18975F]">alecrim.saboresdomundo@gmail.com</a>
                <p class="leading-normal my-5">Alecrim - Sabores do Mundo,

           ...
           <div className="bg-[#18975F] w-full h-4" />  
            <div class="container px-5 py-14 mx-auto">
              <div class="flex flex-col text-center w-full mb-10">
                ...
                <div class="rounded-lg h-80 overflow-hidden mb-20">
                    <img alt="content" class="object-cover object-center h-full w-full" src={C1} />
                </div>
                <div className="flex flex-wrap flex-col lg:flex-row -m-4">
                
               
                <div className="p-4 lg:w-1/4">
                    <div class="h-full flex sm:flex-row flex-col items-start sm:justify-start justify-center text-center sm:text-left">

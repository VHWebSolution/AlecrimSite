                        ...
                        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                            ...
                            <div class="flex-grow sm:pl-8">
                                ...
                                <p class="mb-4">
                                    ...
                                    - Frango TexMex<br></br>
                                    - Carne TexMex (*)<br></br>
                                    - Tomate Seco + Ricota + Espinafre<br></br>
                                    - Calabresa + Ricota + Espinafre<br></br>
                                    - Frango + Requeijão + Ervas<br></br>
                                    - Portuguesa<br></br>
                                    - Calabresa e Brócolis<br></br>
                                    - Carne e Queijo (*)<br></br>
                                    - Frango e Queijo<br></br><br></br>
                                    G: Grande (30 cm) = R$ 30,00<br></br>
                                    M: Médio (15 cm) = R$ 15,00<br></br>
                                    *G (Carne) = R$ 36,00<br></br>
                                    *M (Médio) = R$ 18,00<br></br>
